...
export default function VerifyEmailPage() {
  ...
  const failure = verifyError ? authFailureMessage(verifyError) : null;
  ...
  return (
    <div className="space-y-8">
      <div className="space-y-2">
        <h2 className="text-3xl font-bold">{t('verifyEmail.title')}</h2>
        <p className="text-muted-foreground break-words">{t('verifyEmail.subtitle', { email })}</p>
      </div>
