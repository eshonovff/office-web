...
describe('useOAuthConnectFlow', () => {
  ...
  it('flags an account whose externalId already belongs to an existing channel of this provider', async () => {
    const existing: ChannelListItem[] = [
      { id: 'ch1', type: 'Instagram', name: 'Old name', externalId: 'acc-1', isActive: true, createdAt: '2026-01-01', requiresReconnect: false, webhookSetupWarning: null, credentialsExpiresAt: null },
    ];
