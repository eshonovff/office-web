    ...
    <DropdownMenu>
      <DropdownMenuTrigger
        ...
        <div className="hidden max-w-40 min-w-0 flex-col items-start text-left xl:flex">
          <span className="max-w-full truncate text-sm leading-none font-semibold">{customer?.fullName}</span>
        </div>
            ...
            <div className="bg-primary/3 flex flex-col space-y-3 border-b p-4">
              <div className="flex items-center gap-3">
                ...
                <div className="flex min-w-0 flex-col">
                  <p className="truncate text-sm leading-none font-bold">{customer?.fullName}</p>
                  <p className="text-muted-foreground mt-1 truncate text-xs leading-none">{customer?.email}</p>
                </div>
              </div>
            </div>
          </DropdownMenuLabel>
