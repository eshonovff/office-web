...
| 7 | ✅ (2026-08-12) **`GET /channels/{id}`** акнун `inbox.assign` талаб мекунад (пеш `channels.manage` буд). Frontend-и `route.tsx`-и inbox нав шуд: `assigneeOptions` акнун аз `mergeChannelMembers`-и аъзоёни воқеии ҳар канали `/channels/mine` сохта мешавад (тавассути `useQueries`), на аз "таъиншудагони қаблӣ + худи корбар". Санҷида: `GET /channels/{id}` бо curl (7 аъзо, аз ҷумла 5 корманди нави сохташуда), permission дар `ChannelsEndpoints.cs` тасдиқ шуд | Faridun |
