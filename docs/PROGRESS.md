...
| 7 | ✅ (2026-08-12) `GET /channels/{id}` бо `inbox.assign` кушода шуда буд (аввалин фикс), баъд backend эндпойнти сабуктар сохт: **`GET /conversations/{id}/assignable-users`** (низ `inbox.assign`) — аъзоёни маҳз канали ҳамон чат, барои inbox drop-down/drag-and-drop. Frontend (`route.tsx`) ба ин эндпойнт кӯчид: `assigneeOptions` акнун ба `selectedId` вобаста аст (канали чати кушодашуда), на ба union-и ҳама каналҳо. `PATCH .../assignedTo` бо корманди берун аз канал 409 медиҳад бо сабаби фаҳмо ("Корманди таъиншуда узви канали ин чат нест...") — `client.ts` акнун detail-и backend-ро аз паёми умумии тарҷумашуда бартарӣ медиҳад (ҳама 409/400/... дар тамоми апп, на танҳо ин ҷо). Рӯйхат танҳо аъзоёни каналро медиҳад, на Owner/Admin (гарчанде PATCH онҳоро мегузорад) — агар UI-ро лозим ояд, ки админро низ таъин кардан мумкин бошад, backend бояд эндпойнтро васеъ кунад | Faridun |
