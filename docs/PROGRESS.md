...
| 2026-09-26 | fe-фазаи 19: `/account/analytics` — давра (7 / 30 / 90 рӯз ё санаҳо), аккаунт, 6 корточка бо ↑/↓, диаграммаи рӯзҳо, автоматизатсияҳо (корт: рӯзҳо, оғозкунандагон бо пайванд ба контакт), автоҷавоб, рассылкаҳо, постҳои беҳтарин; менюи «Аналитика» кушода шуд. Конструктор: «N · X%» дар тугмаҳои «next», амали «Мақсад», «Ба мақсад» дар «Омор» | ID-и аккаунт ё автоматизатсияи бегона дар URL сарфи назар мешавад; пайванди пост танҳо саҳифаи https-и худи Instagram. Chrome хатое ёфт, ки тестҳо намедиданд: майдонҳои сана холӣ буданд (flatpickr матни `YYYY-MM-DD`-ро намехонд) — ислоҳ ва тест бо flatpickr-и воқеӣ. Backend: office-api фазаи 19 |
| 2026-09-26 | Чати мизоҷ: тугмаи 🎤 — паёми овозӣ (`useVoiceRecorder`: Chrome, Firefox, Safari/iPhone), «Сабт мешавад… 0:12», бекор кардан, хатои микрофон. Матн нависед — тугма «фиристодан» мешавад. Агар ҷавоб ғайриимкон шавад (тариф, тиреза) ё саҳифа баста шавад, сабт партофта ва микрофон озод мешавад | Корбар: «мизоҷон бояд бо мо баробар бошанд». Кормандон сабтро танҳо дар WebM мекарданд — hook-и нав Safari-ро ҳам дастгирӣ мекунад. Backend: office-api (voice-note, ҳимояи ffmpeg) |
| 2026-09-27 | Суратҳои контактҳо: `useAvatarUrl` — нусхаи сервер бо токен (blob), танҳо роҳҳои `/api/…`; инбокси кормандон (рӯйхат, панел), чатҳо ва контактҳои мизоҷ | Пайванди Meta баъди ~4 рӯз кор намекард — ҳарфи аввал ба ҷои сурат. Backend: office-api `docs/fix-contact-profiles.md` |
